                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <h1 class="text-white display-5">RM Mandiri</h1>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Sales & Inventory Management System</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Selamat Datang Kepembali !</h5>
                                    <p class="text-muted">Masuk untuk melanjutkan ke sistem RM Mandiri.</p>
                                </div>
                                <div class="p-2 mt-4">
