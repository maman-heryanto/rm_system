                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex flex-column gap-2 mt-2">
                                ...
                                <div class="form-check ms-4">
                                    <input class="form-check-input" type="radio" name="type" id="typeSaleDirect" value="sale_direct" {{ old('type') == 'sale_direct' ? 'checked' : '' }} onchange="toggleFields()">
                        ...
                        <div id="sale_direct_fields" style="display: none;">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="existing_item_name" name="existing_item_name" value="{{ old('existing_item_name') }}">
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="direct_quantity_display" class="form-label">Jumlah Terjual</label>
                                    <input type="text" class="form-control" id="direct_quantity_display" placeholder="0" onkeyup="updateInput(this, 'quantity')">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="direct_amount_display" class="form-label">Total Harga (Rp)</label>
                                    <input type="text" class="form-control" id="direct_amount_display" placeholder="Rp 0" onkeyup="updateInput(this, 'amount')">
                                </div>
                            </div>
                        </div>
