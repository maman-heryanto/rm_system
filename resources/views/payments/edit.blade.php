        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('debts.show', $payment->debt_id) }}">Detail</a></li>
    ...
    <div class="col-lg-6 mx-auto">
        <div class="card">
             <div class="card-header">
                <h5 class="card-title mb-0">Perbarui Detail Pembayaran</h5>
            </div>
            <div class="card-body">
                <div class="alert alert-info">
                    <strong>Pelanggan:</strong> {{ $payment->debt->transaction->customer->name ?? 'N/A' }} <br>
                    <strong>Total Hutang:</strong> Rp {{ number_format($payment->debt->amount_total, 0, ',', '.') }}
                </div>
                ...
                <form action="{{ route('payments.update', $payment->id) }}" method="POST" id="edit_payment_form">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Maksimal: Rp {{ number_format($maxAmount, 0, ',', '.') }}</div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('debts.show', $payment->debt_id) }}" class="btn btn-light">Batal</a>
